...
// Muda a cor da sua aplicação iónica para luz, estável, positiva, calma, equilibrada, energizada, assertiva, real ou escura 
.constant ('IONIC_APP_COLOR', 'positivo')

// Alterar modelo de página de posts para cartões, cards2, list
...
// Substituir por e-mail para enviar cópia Comentários ou deixar vazio
.constant ('COPY_EMAIL', 'app2@myapp.com')

// Substituir por número de telefone para enviar SMS
